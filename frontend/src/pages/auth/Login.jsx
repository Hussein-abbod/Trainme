      ...
      <div className="flex flex-col md:flex-row w-full h-full">
        ...
        <div className="w-full md:w-7/12 lg:w-1/2 flex items-center justify-center p-md sm:p-lg lg:p-xl bg-surface-container-lowest overflow-y-auto">
          <div className="w-full max-w-[420px]">
            ...
            <div className="mt-md">
              <button type="button" className="w-full py-sm px-md rounded-lg bg-surface-container-lowest border border-outline-variant text-on-surface font-label-md text-label-md flex justify-center items-center gap-sm hover:bg-surface-container-low hover:border-outline transition-colors">
