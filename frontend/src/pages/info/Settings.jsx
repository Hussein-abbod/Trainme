        ...
        <form onSubmit={handleSave} className="bg-surface-container-lowest border border-surface-variant rounded-xl p-lg flex flex-col gap-lg shadow-sm">
          ...
          <div className="pt-lg border-t border-surface-variant">
            ...
            <div className="flex flex-col gap-xs max-w-sm">
              ...
              <input type="password" placeholder="New Password" className="border border-outline-variant rounded-lg px-3 py-2 bg-surface focus:ring-1 focus:ring-primary outline-none" />
              <input type="password" placeholder="Confirm New Password" className="border border-outline-variant rounded-lg px-3 py-2 bg-surface focus:ring-1 focus:ring-primary outline-none mt-2" />
            </div>
          </div>
